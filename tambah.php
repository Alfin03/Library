...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="peminjaman.html" aria-controls="collapseTwo">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="tables.html" aria-controls="collapseUtilities">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Alfin Gosal</span>
                ...
                <div class="container-fluid">
                    ...
                    <form class="form-horizontal" method="post" action="tambah.php">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="idbuku" placeholder="ID Buku" required name="idbuku">
                            </div>
                        </div>
                        ...
                        <div class="form-group text-left">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="judul" placeholder="Masukkan Judul Buku" required name="judul">
                            </div>
                        </div>
                        ...
                        <div class="form-group text-left">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="pengarang" placeholder="Masukkan Nama Pengarang" required name="pengarang">
                            </div>
                        </div>
                ...
                ?>
                        ...
                        <div class="form-group text-left">
                            ...
                            <div class="col-sm-1">
                                <input type="number" class="form-control" id="jumlah" placeholder="Nomor Telepon anda" required min="0" value="0" name="jumlah">
                            </div>
                        </div>
...
$queryinsert = mysqli_query($connect, "INSERT INTO buku (id_buku,nama_buku,pengarang,tahun,jumlah) VALUES ('$id','$judul','$pengarang','$tahun','$jumlah')");
if ($queryinsert)
{
